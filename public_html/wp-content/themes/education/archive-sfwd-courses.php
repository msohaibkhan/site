...
get_header(); 
?>
    <?php if (is_active_sidebar( 'search-sidebar-courses' )) : ?>
        <div class="education-search-courses">
            <div class="container">
                <?php dynamic_sidebar( 'search-sidebar-courses' ); ?>
            </div>
        </div>
    <?php endif; ?>
    <div id="primary" class="content-area">
        <div class="container education-category-sfwd-courses">
            <div class="row">
