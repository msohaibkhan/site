   ...
   if ($get_response === false) {
      ...
      if ($zip->open ($beta_zip_filepath) === true) {
         ...
         if ($zip->extractTo ($beta_dir) === true) {
            ...
            // BlueHost, for one, requires browse_dataset_questions.php to NOT
            // have group write permissions set.  Set permissions explicitly.
            $browse_dataset_questions = $beta_dir . 'browse_dataset_questions.php';
            chmod ($browse_dataset_questions, 0644);
         } else {
   ...
   if ($get_response === false) {
      ...
      if ($zip->open ($version_zip_filepath) === true) {
         if ($zip->extractTo ($plugin_dir) === true) {
            ...
            // BlueHost, for one, requires browse_dataset_questions.php to NOT
            // have group write permissions set.  Set permissions explicitly.
            $browse_dataset_questions = $plugin_dir . 'browse_dataset_questions.php';
            chmod ($browse_dataset_questions, 0644);
         } else {
